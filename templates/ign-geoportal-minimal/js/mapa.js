...
$('#top-left-logo').attr("src","templates/ign-geoportal-basic/img/Header_IDE.png");
//$('#top-left-logo').attr("alt","Logo Instituto Geográfico Nacional");
$('#top-left-logo').attr("title","Infraestructura de datos");
//$('#top-right-logo-link').attr("href","https://www.argentina.gob.ar/defensa");
$('#top-right-logo').attr("src","templates/ign-geoportal-basic/img/Marca_Prov.png");
$('#top-right-logo').attr("alt","Logo Provincia de Buenos Aires");
